import type { ServiceReport } from "@/features/maintenance/types";
...
async function proxyDetail(request: Request, { params }: Context, init: RequestInit = {}) { return maintenanceProxy<ServiceReport>(request, detailPath(apiEndpoints.services, (await params).id), init); }
