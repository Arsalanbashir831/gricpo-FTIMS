...
export interface TechnicianReport {
  id: number; report_number: string; technician: number; technician_name: string; equipment: number[];
  equipment_details: ReportEquipment[]; project_site: number; project_site_name: string; client: number;
  remarks: string; test_method: string; test_date: string; report_file: string | null; status: ReportStatusCode;
