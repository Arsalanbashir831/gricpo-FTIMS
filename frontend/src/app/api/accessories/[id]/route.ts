...
async function proxyDetail(request: Request, { params }: Context, init: RequestInit = {}) { return allocationProxy<Accessory>(request, detailPath(apiEndpoints.accessories, (await params).id), init); }
